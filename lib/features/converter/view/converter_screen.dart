  ...
  void _handleCreateCustom(ConverterNotifier notifier) {
    ...
    if (name.isEmpty || from.isEmpty || to.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        ...
        SnackBar(content: Text('所有公式字段均为必填项'), backgroundColor: Colors.purpleAccent),
          ...
          return ScaleOnTap(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                color: isSel ? color.withOpacity(0.12) : isDark ? Colors.white.withOpacity(0.015) : Colors.black.withOpacity(0.02),

                borderRadius: BorderRadius.circular(16),

                border: Border.all(

                  color: isSel ? color.withOpacity(0.5) : isDark ? Colors.white.withOpacity(0.05) : Colors.black.withOpacity(0.05),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('设计自定义公式转换卡片', style: TextStyle(color: textColor, fontWeight: FontWeight.bold, fontSize: 14)),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          ...
                          BoxShadow(color: Colors.purpleAccent.withOpacity(0.3), blurRadius: 10, offset: Offset(0, 4))
                      ...
                      child: Center(
                        ...
                        child: Text('一 键 注 入 并 启 用', style: TextStyle(color: textColor, fontWeight: FontWeight.bold)),
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: Theme(
                    ...
                    data: Theme.of(context).copyWith(canvasColor: Theme.of(context).colorScheme.surfaceContainer),
              ...
              Expanded(
                ...
                child: isReadOnly
                    ...
                    : TextFormField(
                        ...
                        style: TextStyle(color: textColor, fontSize: 30, fontWeight: FontWeight.bold, letterSpacing: -0.5),
  ...
  Widget _buildDetailsAndGuides(ConverterCategory category, Color color) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isDark ? Colors.white.withOpacity(0.02) : Colors.black.withOpacity(0.03)),
