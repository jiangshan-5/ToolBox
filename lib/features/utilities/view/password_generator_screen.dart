              ...
              children: [
                            ...
                            : () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  ...
                                  SnackBar(
                                    ...
                                    backgroundColor: Theme.of(context).brightness == Brightness.dark ? Color(0xFF0F0C29) : Theme.of(context).colorScheme.surfaceContainer,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isDark ? isDark ? Colors.white.withOpacity(0.015) : Colors.black.withOpacity(0.02) : Colors.black.withOpacity(0.02),

                    borderRadius: BorderRadius.circular(16),

                    border: Border.all(color: isDark ? isDark ? Colors.white.withOpacity(0.04) : Colors.black.withOpacity(0.04) : Colors.black.withOpacity(0.04)),
