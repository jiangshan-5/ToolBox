          ...
          builder: (context) => AlertDialog(
            ...
            title: Row(
              children: [
                ...
                Text('测试成功', style: TextStyle(color: textColor)),
              ],
            ),
            content: Column(
          ...
          builder: (context) => AlertDialog(
            ...
            title: Row(
              children: [
                ...
                const SizedBox(width: 10),
                Text('联通失败', style: TextStyle(color: textColor)),
              ],
            ),
            content: Column(
              mainAxisSize: MainAxisSize.min,
                                ...
                                children: suggestions.map((model) {
                                  ...
                                  return ChoiceChip(
                                    label: Text(
                                      ...
                                      style: TextStyle(
                                        color: isSelected
                                            ? (isDark ? Colors.black : Colors.cyan.shade900)
                                            : textColor,
                                        fontSize: 12,
                                    ...
                                    selected: isSelected,
                                    selectedColor: isDark ? Colors.cyanAccent : Colors.cyan.shade100,
